	...
	if (isset($_SESSION["shopping_cart"])) {
		...
		$item_array_id= array_column($_SESSION["shopping_cart"], "item_id");
			if (!in_array($_GET["id"], $item_array_id)) {
				...
				echo '<script>window.location="cata_men.php"</script>';
			}
...
<?php
 ...
 $sql2 = "SELECT* from products where cate_id='1' order by p_id asc";
...
?>
			<div class="column">
				<br height="2px">
				<form method="post" action="cata_men.php?action=add&id=<?php echo $row1['p_id'] ?>">
